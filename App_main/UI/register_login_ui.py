...
class Ui_lw_main(object):
    def setupUi(self, lw_main):
        ...
        self.widget = QtWidgets.QWidget(parent=self.gb_register)
        self.widget.setGeometry(QtCore.QRect(10, 33, 451, 30))
        self.widget.setObjectName("widget")
        self.hl_register_fname = QtWidgets.QHBoxLayout(self.widget)
        self.hl_register_fname.setContentsMargins(0, 0, 0, 0)
        self.hl_register_fname.setObjectName("hl_register_fname")
        self.lb_register_fname_icon = QtWidgets.QLabel(parent=self.widget)
        ...
        self.lb_register_fname = QtWidgets.QLabel(parent=self.widget)
        self.lb_register_fname.setObjectName("lb_register_fname")
        self.hl_register_fname.addWidget(self.lb_register_fname)
        self.le_register_fname = QtWidgets.QLineEdit(parent=self.widget)
        self.le_register_fname.setObjectName("le_register_fname")
        self.hl_register_fname.addWidget(self.le_register_fname)
        self.widget1 = QtWidgets.QWidget(parent=self.gb_register)
        self.widget1.setGeometry(QtCore.QRect(10, 69, 451, 30))
        self.widget1.setObjectName("widget1")
        self.hl_register_lname = QtWidgets.QHBoxLayout(self.widget1)
        self.hl_register_lname.setContentsMargins(0, 0, 0, 0)
        self.hl_register_lname.setObjectName("hl_register_lname")
        self.lb_register_lname_icon = QtWidgets.QLabel(parent=self.widget1)
        ...
        self.lb_register_lname = QtWidgets.QLabel(parent=self.widget1)
        self.lb_register_lname.setObjectName("lb_register_lname")
        self.hl_register_lname.addWidget(self.lb_register_lname)
        self.le_register_lname = QtWidgets.QLineEdit(parent=self.widget1)
        self.le_register_lname.setObjectName("le_register_lname")
        self.hl_register_lname.addWidget(self.le_register_lname)
        self.widget2 = QtWidgets.QWidget(parent=self.gb_register)
        self.widget2.setGeometry(QtCore.QRect(10, 105, 451, 30))
        self.widget2.setObjectName("widget2")
        self.hl_register_email = QtWidgets.QHBoxLayout(self.widget2)
        self.hl_register_email.setContentsMargins(0, 0, 0, 0)
        self.hl_register_email.setObjectName("hl_register_email")
        self.lb_register_email_icon = QtWidgets.QLabel(parent=self.widget2)
        ...
        self.lb_register_email = QtWidgets.QLabel(parent=self.widget2)
        self.lb_register_email.setObjectName("lb_register_email")
        self.hl_register_email.addWidget(self.lb_register_email)
        self.le_register_email = QtWidgets.QLineEdit(parent=self.widget2)
        self.le_register_email.setObjectName("le_register_email")
        self.hl_register_email.addWidget(self.le_register_email)
        self.widget3 = QtWidgets.QWidget(parent=self.gb_register)
        self.widget3.setGeometry(QtCore.QRect(10, 141, 451, 30))
        self.widget3.setObjectName("widget3")
        self.hl_register_password = QtWidgets.QHBoxLayout(self.widget3)
        self.hl_register_password.setContentsMargins(0, 0, 0, 0)
        self.hl_register_password.setObjectName("hl_register_password")
        self.lb_register_password_icon = QtWidgets.QLabel(parent=self.widget3)
        ...
        self.lb_register_password = QtWidgets.QLabel(parent=self.widget3)
        ...
        self.le_register_password = QtWidgets.QLineEdit(parent=self.widget3)
        ...
        self.widget4 = QtWidgets.QWidget(parent=self.gb_register_question)
        self.widget4.setGeometry(QtCore.QRect(9, 70, 451, 34))
        self.widget4.setObjectName("widget4")
        self.hl_register_question = QtWidgets.QHBoxLayout(self.widget4)
        self.hl_register_question.setContentsMargins(0, 0, 0, 0)
        self.hl_register_question.setObjectName("hl_register_question")
        self.lb_register_question_icon = QtWidgets.QLabel(parent=self.widget4)
        ...
        self.lb_register_question = QtWidgets.QLabel(parent=self.widget4)
        ...
        self.le_register_question = QtWidgets.QLineEdit(parent=self.widget4)
        ...
        self.widget5 = QtWidgets.QWidget(parent=self.gb_register_question)
        self.widget5.setGeometry(QtCore.QRect(9, 110, 451, 34))
        self.widget5.setObjectName("widget5")
        self.hl_register_answer = QtWidgets.QHBoxLayout(self.widget5)
        self.hl_register_answer.setContentsMargins(0, 0, 0, 0)
        self.hl_register_answer.setObjectName("hl_register_answer")
        self.lb_register_answer_icon = QtWidgets.QLabel(parent=self.widget5)
        ...
        self.sb_register_dob_month = QtWidgets.QSpinBox(parent=self.widget6)
        ...
        self.sb_register_dob_year = QtWidgets.QSpinBox(parent=self.widget6)
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(270, 360, 201, 42))
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(10, 410, 461, 34))
        self.layoutWidget5.setObjectName("layoutWidget5")
        self.hl_register_message = QtWidgets.QHBoxLayout(self.layoutWidget5)
        ...
        self.widget7 = QtWidgets.QWidget(parent=self.gb_reset_get_question)
        self.widget7.setGeometry(QtCore.QRect(280, 110, 174, 42))
        self.widget7.setObjectName("widget7")
        self.hl_reset_get_question = QtWidgets.QHBoxLayout(self.widget7)
        self.hl_reset_get_question.setContentsMargins(0, 0, 0, 0)
        self.hl_reset_get_question.setObjectName("hl_reset_get_question")
        self.pb_reset_get_question = QtWidgets.QPushButton(parent=self.widget7)
        icon3 = QtGui.QIcon()
        ...
        self.pb_reset_get_cancel = QtWidgets.QPushButton(parent=self.widget7)
        ...
        self.widget8 = QtWidgets.QWidget(parent=self.gb_reset_get_question)
        self.widget8.setGeometry(QtCore.QRect(10, 70, 451, 31))
        self.widget8.setObjectName("widget8")
        self.hl_reset_dob = QtWidgets.QHBoxLayout(self.widget8)
        self.hl_reset_dob.setContentsMargins(0, 0, 0, 0)
        self.hl_reset_dob.setObjectName("hl_reset_dob")
        self.lb_reset_dob = QtWidgets.QLabel(parent=self.widget8)
        self.lb_reset_dob.setObjectName("lb_reset_dob")
        self.hl_reset_dob.addWidget(self.lb_reset_dob)
        self.sb_reset_dob_day = QtWidgets.QSpinBox(parent=self.widget8)
        ...
        self.sb_reset_dob_month = QtWidgets.QSpinBox(parent=self.widget8)
        ...
        self.sb_reset_dob_year = QtWidgets.QSpinBox(parent=self.widget8)
        ...
        self.layoutWidget6 = QtWidgets.QWidget(parent=self.gb_reset_password)
        self.layoutWidget6.setGeometry(QtCore.QRect(230, 360, 236, 42))
        self.layoutWidget6.setObjectName("layoutWidget6")
        self.hl_reset_buttons = QtWidgets.QHBoxLayout(self.layoutWidget6)
        self.hl_reset_buttons.setContentsMargins(0, 0, 0, 0)
        self.hl_reset_buttons.setObjectName("hl_reset_buttons")
        self.pb_reset_login = QtWidgets.QPushButton(parent=self.layoutWidget6)
        ...
        self.pb_reset_cancel = QtWidgets.QPushButton(parent=self.layoutWidget6)
        ...
        self.layoutWidget7 = QtWidgets.QWidget(parent=self.gb_reset_password)
        self.layoutWidget7.setGeometry(QtCore.QRect(10, 410, 461, 34))
        self.layoutWidget7.setObjectName("layoutWidget7")
        self.hl_reset_message = QtWidgets.QHBoxLayout(self.layoutWidget7)
        self.hl_reset_message.setContentsMargins(0, 0, 0, 0)
        self.hl_reset_message.setObjectName("hl_reset_message")
        self.lb_reset_message_icon = QtWidgets.QLabel(parent=self.layoutWidget7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lb_reset_message = QtWidgets.QLabel(parent=self.layoutWidget7)
        ...
        self.layoutWidget8 = QtWidgets.QWidget(parent=self.gb_reset_reset_password)
        self.layoutWidget8.setGeometry(QtCore.QRect(0, 140, 451, 34))
        self.layoutWidget8.setObjectName("layoutWidget8")
        self.hl_reset_repeat_pass = QtWidgets.QHBoxLayout(self.layoutWidget8)
        self.hl_reset_repeat_pass.setContentsMargins(0, 0, 0, 0)
        self.hl_reset_repeat_pass.setObjectName("hl_reset_repeat_pass")
        self.lb_reset_repeat_pass_icon = QtWidgets.QLabel(parent=self.layoutWidget8)
        ...
        self.lb_reset_repeat_pass = QtWidgets.QLabel(parent=self.layoutWidget8)
        ...
        self.le_reset_repeat_pass = QtWidgets.QLineEdit(parent=self.layoutWidget8)
        ...
        self.layoutWidget9 = QtWidgets.QWidget(parent=self.gb_reset_reset_password)
        self.layoutWidget9.setGeometry(QtCore.QRect(0, 100, 451, 34))
        self.layoutWidget9.setObjectName("layoutWidget9")
        self.hl_reset_new_pass = QtWidgets.QHBoxLayout(self.layoutWidget9)
        self.hl_reset_new_pass.setContentsMargins(0, 0, 0, 0)
        self.hl_reset_new_pass.setObjectName("hl_reset_new_pass")
        self.lb_reset_new_pass_icon = QtWidgets.QLabel(parent=self.layoutWidget9)
        ...
        self.lb_reset_new_pass = QtWidgets.QLabel(parent=self.layoutWidget9)
        self.lb_reset_new_pass.setObjectName("lb_reset_new_pass")
        self.hl_reset_new_pass.addWidget(self.lb_reset_new_pass)
        self.le_reset_new_pass = QtWidgets.QLineEdit(parent=self.layoutWidget9)
        self.le_reset_new_pass.setObjectName("le_reset_new_pass")
        self.hl_reset_new_pass.addWidget(self.le_reset_new_pass)
        self.layoutWidget10 = QtWidgets.QWidget(parent=self.gb_reset_reset_password)
        self.layoutWidget10.setGeometry(QtCore.QRect(0, 60, 451, 34))
        self.layoutWidget10.setObjectName("layoutWidget10")
        self.hl_reset_answer = QtWidgets.QHBoxLayout(self.layoutWidget10)
        self.hl_reset_answer.setContentsMargins(0, 0, 0, 0)
        self.hl_reset_answer.setObjectName("hl_reset_answer")
        self.lb_reset_answer_icon = QtWidgets.QLabel(parent=self.layoutWidget10)
        ...
        self.le_reset_answer = QtWidgets.QLineEdit(parent=self.layoutWidget10)
        self.le_reset_answer.setObjectName("le_reset_answer")
        self.hl_reset_answer.addWidget(self.le_reset_answer)
        self.layoutWidget11 = QtWidgets.QWidget(parent=self.gb_reset_reset_password)
        self.layoutWidget11.setGeometry(QtCore.QRect(0, 20, 451, 34))
        self.layoutWidget11.setObjectName("layoutWidget11")
        self.hl_reset_question = QtWidgets.QHBoxLayout(self.layoutWidget11)
        self.hl_reset_question.setContentsMargins(0, 0, 0, 0)
        self.hl_reset_question.setObjectName("hl_reset_question")
        self.lb_reset_question_icon = QtWidgets.QLabel(parent=self.layoutWidget11)
        ...
        self.lb_reset_question = QtWidgets.QLabel(parent=self.layoutWidget11)
        ...
        lw_main.setTabOrder(self.pb_login_login, self.le_login_password)
        lw_main.setTabOrder(self.le_login_password, self.le_register_fname)
        lw_main.setTabOrder(self.le_register_fname, self.pb_login_cancel)
        lw_main.setTabOrder(self.pb_login_cancel, self.pb_reset_get_question)
        lw_main.setTabOrder(self.pb_reset_get_question, self.le_register_lname)
        ...
        lw_main.setTabOrder(self.le_register_password, self.le_register_question)
        lw_main.setTabOrder(self.le_register_question, self.le_register_answer)
        lw_main.setTabOrder(self.le_register_answer, self.pb_main_login)
        lw_main.setTabOrder(self.pb_main_login, self.pb_register_sign_up)
        lw_main.setTabOrder(self.pb_register_sign_up, self.pb_register_cancel)
        lw_main.setTabOrder(self.pb_register_cancel, self.le_reset_answer)
        ...
        lw_main.setTabOrder(self.pb_reset_cancel, self.le_login_username)
        lw_main.setTabOrder(self.le_login_username, self.pb_main_forgot_pass)
        lw_main.setTabOrder(self.pb_main_forgot_pass, self.pb_main_sign_in)
        lw_main.setTabOrder(self.pb_main_sign_in, self.le_reset_name)
        lw_main.setTabOrder(self.le_reset_name, self.stackedWidget)
        lw_main.setTabOrder(self.stackedWidget, self.pb_reset_get_cancel)
